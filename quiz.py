...
dic = {
    ...
    "choices": [
        ["Guido van Rossum", "Niene Stom", "Zim Den"],
        ["Pointers", "Loops", "Dynamic typing"],
        ["key", "Indentation", "Brackets"],
        ["16", "32", "No fixed length is specified"]
    ],
    "answers": [1, 1, 2, 3]
}
...
def Page1():
    ...
    canvas.create_rectangle(50, 140, 850, 600, fill="royalblue")
    ...
    global button_1
    button_1 = Button(
        canvas, text='>', height=1, width=1, bg="royalblue", fg="white", font=("Arial", 50), borderwidth=0, command=NEXT
    )
...
def options(question_no):
    option_1 = Button(
        canvas, text=dic["choices"][question_no - 1][0], height=1, width=18, bg="royalblue", fg="white",
    ...
    option_2 = Button(
        canvas, text=dic["choices"][question_no - 1][1], height=1, width=18, bg="royalblue", fg="white",
        font=("Arial", 20), borderwidth=8, highlightbackground="grey",
        command=lambda: Update_score(question_no - 1, 2)
    )
    option_2.place(x=100, y=400)
    option_3 = Button(
        canvas, text=dic["choices"][question_no - 1][2], height=1, width=18, bg="royalblue", fg="white",
        font=("Arial", 20), borderwidth=8, highlightbackground="grey",
